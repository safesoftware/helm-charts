...
To quickly get started, find the latest docker image tag for this version of FME Server [here](https://hub.docker.com/r/safesoftware/fmeserver-core/tags?page=1&name=2021.0&ordering=last_updated).

Then run the command specifying the docker tag found above:
`helm install fmeserver safesoftware/fmeserver-2021.0.3 --set fmeserver.image.tag=<docker_tag>`

See all available parameters below.

For more information see the [documentation](https://docs.safe.com/fme/2021.0/html/FME_Server_Documentation/AdminGuide/Kubernetes/Kubernetes-Deploying-Intro.htm).

## Configuration

The following table lists the configurable parameters of the FME Server 2021.0 chart and their default values.

|      Parameter      |               Description             |                    Default                |
|---------------------|---------------------------------------|-------------------------------------------|
| `fmeserver.image.tag` | The docker image tag to use. |  `Nil` You must provide a tag. You can find available tags [here](https://hub.docker.com/r/safesoftware/fmeserver-core/tags?page=1&name=2021.0&ordering=last_updated). |
